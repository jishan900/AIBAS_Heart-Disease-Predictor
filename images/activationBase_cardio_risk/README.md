...
docker compose -f images/activationBase_cardio_risk/Docker-compose.yml up --remove-orphans
docker compose -f images/activationBase_cardio_risk/Docker-compose.yml down 
```
